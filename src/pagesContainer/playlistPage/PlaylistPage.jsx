...
const PlaylistPage = ({ songs }) => {
  ...
  console.log(
    ...
    "mn is created by admin idhar aa gya"
  );
  ...
  console.log("Songs from Playlist Page: ", songs.length);
  //   console.log(playlist, "mn playlist page se playlist hn ");
  ...
  const [playlistName, setPlaylistName] = useState("hello");
  ...
  useEffect(() => {
    ...
    // setPlaylistName(songArray[currentSongIndex]?.Song_Name);
    ...
    console.log(songArray[currentSongIndex], "mn playlist ka naam hn ");
  ...
  useEffect(() => {
    ...
    // if (!songs?.length) return route.replace("/");  //// ye change
  ...
  console.log(
    songArray[0]?.Album_Image,
    "something about image in playlist page"
  );
  console.log(
    `${process.env.media_url}/${songArray[0]?.Album_Image}`,
    "media url "
  );
  ...
  return (
    <div className={classes.albums}>
      ...
      <div className={classes.lyricsToggleButtonContainer}>
        <div
          className={classes.lyricsToggleButtonMain}
          ...
          {!isOn ? (
            ...
            <div className={classes.lyricsViewMain}>
              <div className={classes.lyricsViewTextContainer}>
                ...
                >
                  <button
                    className={classes.lyricsViewCloseButton}
                    checked={isOn}
                ...
                <div style={{ position: "relative", width: "100%", flex: 1 }}>
                  ...
                  >
                    {(() => {
                      ...
                      const lyricsArray = lyricsInString
                        .replace(/"/g, "")
                        .split("\\r\\n");

                      if (lyricsArray.length === 1 && lyricsArray[0] === "") {
                        return <p>No lyrics to display</p>;
                      } else {
                        return lyricsArray.map((text, index) => (
